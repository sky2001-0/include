...
namespace ps
{
  inline constexpr double m_ps = 2 * u::m_e; // mass of unbind positronium
  inline constexpr double ps_ortho1S_binding_energy  = -6.80246955484722 * u::eV; // energy level of 1S ortho-positronium
  inline constexpr double ps_ortho2S_binding_energy  = -1.70068001565997 * u::eV; // energy level of 2S ortho-positronium
  inline constexpr double ps_ortho2P0_binding_energy = -1.70075651825776 * u::eV; // energy level of 2P0 ortho-positronium
  inline constexpr double ps_ortho2P1_binding_energy = -1.70073383065060 * u::eV; // energy level of 2P1 ortho-positronium
  inline constexpr double ps_ortho2P2_binding_energy = -1.70071569286024 * u::eV; // energy level of 2P2 ortho-positronium

  inline constexpr double ps_para1S_binding_energy = -6.80331071661968 * u::eV; // energy level of 1S para-positronium
  inline constexpr double ps_para2S_binding_energy = -1.70078516365589 * u::eV; // energy level of 2S para-positronium
  inline constexpr double ps_para2P_binding_energy = -1.70072627464065 * u::eV; // energy level of 2P para-positronium
